...
/**
 * Uygulama geneli event bus.
 *
 * Inject katmanı eklendiğinde native hook'lar buraya [PacketEvent] publish eder.
 * Modüller [PacketListener] arayüzü aracılığıyla dinler.
 */
